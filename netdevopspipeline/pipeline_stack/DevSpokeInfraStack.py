    ...
    def __init__(self, scope: Construct, construct_id: str, cidr: str, **kwargs) -> None:
        ...
        self.tgw_param_reader = cr.AwsCustomResource(
            ...
            policy=cr.AwsCustomResourcePolicy.from_statements(
                statements=[
                    iam.PolicyStatement(
                        ...
                        resources=[
                            f"arn:{Aws.PARTITION}:iam::{netdevopspipeline.accounts.Dev_Hub_Primary_ENV.account}:role/CentralTgwId-readerRole"
                        ],
                    )
                ]
            ),
            on_create=cr.AwsSdkCall(
                ...
                assumed_role_arn=f"arn:{Aws.PARTITION}:iam::{netdevopspipeline.accounts.Dev_Hub_Primary_ENV.account}:role/CentralTgwId-readerRole",
